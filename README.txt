...
%-d	Day of the month as a decimal number.				Example - Example - 1, 2, ..., 30
...
%-m	Month as a decimal number.					Example - 1, 2, ..., 12
%y	Year without century as a zero-padded decimal number.		Example - 00, 01, ..., 99
%-y	Year without century as a decimal number.			Example - 0, 1, ..., 99
%Y	Year with century as a decimal number.				Example - 2013, 2019 etc.
%H	Hour (24-hour clock) as a zero-padded decimal number.		Example - 00, 01, ..., 23
%-H	Hour (24-hour clock) as a decimal number.			Example - 0, 1, ..., 23
%I	Hour (12-hour clock) as a zero-padded decimal number.		Example - 01, 02, ..., 12
%-I	Hour (12-hour clock) as a decimal number.			Example - 1, 2, ... 12
%p	Locale’s AM or PM.						Example - AM, PM
%M	Minute as a zero-padded decimal number.				Example - 00, 01, ..., 59
%-M	Minute as a decimal number.					Example - 0, 1, ..., 59
...
%W	Week number of the year (Monday as the first day of the week), All days in a new year preceding the first Monday are considered to be in week 0.	Example - 00, 01, ..., 53
